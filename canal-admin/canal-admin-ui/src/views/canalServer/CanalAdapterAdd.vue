  ...
  <div>
    <el-form ref="form" :model="form">
      <div class="filter-container" style="padding-left: 10px;padding-top: 20px;">
        <el-input v-model="form.name" placeholder="adapter名称" style="width: 200px;" class="filter-item" />
<!--        <el-select v-model="form.instance" placeholder="所属instance" class="filter-item">-->
<!--          <el-option-group v-for="group in options" :key="group.label" :label="group.label">-->
<!--            <el-option v-for="item in group.options" :key="item.value" :label="item.label" :value="item.value" />-->
<!--          </el-option-group>-->
<!--        </el-select>-->
        <el-input v-model="form.instance" placeholder="所属instance" style="width: 200px;" class="filter-item" />
      ...
      this.$confirm(
        ...
        addCanalAdapter(this.form).then(response => {
          if (response.data === 'success') {
            ...
            this.$router.push('/canalServer/CanalAdapter')
          } else {
            this.$message({
              message: '新建失败',
              type: 'error'
