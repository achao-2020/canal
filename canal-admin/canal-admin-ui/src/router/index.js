...
export const constantRoutes = [
...

  {
    ...
    children: [
      ...
      {
        path: 'canalAdapter',
        name: 'Canal adapter管理',
        component: () => import('@/views/canalServer/CanalAdapter'),
        meta: { title: 'adapter管理', icon: 'tree' }
      },
      {
        path: 'canalAdapter/modify',
        name: '修改adapter配置',
        component: () => import('@/views/canalServer/CanalAdapterUpdate'),
        meta: { title: 'adapter配置修改' },
        hidden: true
      },
      {
      ...
      },
      {
        ...
        name: '新建Adapter配置',
        component: () => import('@/views/canalServer/CanalAdapterAdd'),
      ...
      {
        path: 'canalAdapter/table',
        name: '同步表',
        component: () => import('@/views/canalServer/CanalAdapterTable'),
        meta: { title: 'Adapter 同步表' },
        hidden: true
      },
      {
        path: '/canalAdapter/table/config',
        name: '同步表字段映射修改',
        component: () => import('@/views/canalServer/CanalAdapterTableCofig'),
        meta: { title: 'table 字段映射修改' },
        hidden: true
      },
      {
        path: '/canalAdapter/table/add',
        name: '同步表增加',
        component: () => import('@/views/canalServer/CanalAdapterTableAdd'),
        meta: { title: '同步表增加' },
        hidden: true
      }
    ]
